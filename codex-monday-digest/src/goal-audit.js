...
const GATE_CATALOG = [
  ...
  gate("source_reuse_contract", /skill package includes `references\/source-reuse-contract\.json`/i, ["proof:skill"], "covered_by_local_proof", "Bundled machine-readable SullyLink pattern contract validation."),
